...
(function ($) {
       ...
       for (const container of videoContainers) {
           ...
           container.addEventListener('mouseenter', () => {
               try {
                   ...
                   handleVideoError('Error occurred while playing the video:', error);
               }
           });
           ...
           container.addEventListener('mouseleave', () => {
               try {
                   if (!video.paused) {
                       video.pause();
                       video.load(); // Reset video to the beginning
                       audio.pause();
                       audio.load(); // Reset audio to the beginning
                   }
               } catch (error) {
                   handleVideoError('Error occurred while pausing the video:', error);
               }
           });
       }
       
       function handleVideoError(message, error) {
           // Implement a more robust error handling mechanism or logging library here
           // Example: log to a centralized error tracking system or log file
    ...
    */
    ...
    document.querySelector('.subscribe').onsubmit = function(event) {
    ...
    if (emailIsValid(email)) {
        ...
        // Display confirmation message when leaving the page
        window.onbeforeunload = function() {
            return "No working"; // Replace with your desired message
        };
    } else {
